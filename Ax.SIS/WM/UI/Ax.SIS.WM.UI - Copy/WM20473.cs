...
namespace Ax.SIS.WM.UI
{
    ...
    /// 반제품 부품식별표 발행
    /// </summary>
    public partial class WM20473 : AxCommonBaseControl
    {
        ...
        private void Inquery_Partno()
        {
            try
            {
                ...
                DataSet source = _WSCOM.ExecuteDataSet("APG_WM20473.INQUERY_PARTNO", paramSet);
        ...
        private void Inquery_All()
        {
            try
            {
                ...
                DataSet source = _WSCOM.ExecuteDataSet("APG_WM20473.INQUERY_ALL", paramSet);
        ...
        private bool IsProcMasterDeleteValid(DataSet source)
        {
            ...
            foreach (DataRow row in source.Tables[0].Rows)
            {
                ...
                DataSet ds = _WSCOM.ExecuteDataSet("APG_WM20473.CHECK_REMOVE_PROC", paramSet);
        ...
        private void Inquery_Detail(string PARTNO) //aa
        {
            try
            {
                ...
                //this.BeforeInvokeServer(true);
                //DataSet source = _WSCOM.ExecuteDataSet("APG_WM20473.INQUERY_PARTNO_DETAIL", paramSet);
                //this.AfterInvokeServer();
