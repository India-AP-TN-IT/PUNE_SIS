...
namespace Ax.SIS.WM.UI
{
    ...
    /// WMS 상품자재재고 조회
    /// </summary>
    public partial class WM20551 : AxCommonBaseControl
    {
        //private IWM20530 _WSCOM;
        ...
        protected override void UI_Shown(EventArgs e)
        {
            try
            {
                ...
                this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.C, 80, "DELI_DATE", "DELI_DATE", "DELIVERY_DATE");
                this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.R, 70, "Deli.Count", "DELI_CNT", "DELI_CNT");
                this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.L, 159, "Delivery NOTE", "BARCODE_NOTE", "DELI_NOTE");
                ...
                //this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.C, 60, "M/TYPE", "MAT_TYPE", "MAT_TYPE");SAP에서는 MAT_TYPE 없음. 2018.12.12
                ...
                this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.C, 80, "Scan Date", "STOCK_DATE");
                this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.C, 80, "Scan Time", "STOCK_TIME");
                this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.C, 80, "Inspect Target", "INSPECT_YN", "INSPECTION");
        ...
        protected override void BtnQuery_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                paramSet.Add("DELI_ST_DATE", this.dtp01_SDATE.GetValue());
                paramSet.Add("DELI_ED_DATE", this.dtp01_EDATE.GetValue());
                paramSet.Add("LANG_SET", this.UserInfo.Language);

                this.BeforeInvokeServer(true);
                this.grd01.BeginUpdate();

                DataSet source = _WSCOM.ExecuteDataSet("APG_WM20551.INQUIRY", paramSet);
                ...
                //this.grd01.Subtotal(AggregateEnum.Var, 1, this.grd01.Cols["DELI_QTY"].Index, this.grd01.Cols["MAT_TYPE"].Index);SAP에서는 MAT_TYPE 없음. 2018.12.12
