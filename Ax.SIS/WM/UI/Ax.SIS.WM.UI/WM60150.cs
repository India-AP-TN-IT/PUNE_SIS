    ...
    public partial class WM60150 : AxCommonBaseControl
    {
        ...
        protected override void UI_Shown(EventArgs e)
        {
            try
            {
                ...
                this.grd01.AddColumn(true, false, AxFlexGrid.FtextAlign.L, 80, "BANK_TERM", "BANK_TERM", "BANK_TERM");
        ...
        protected override void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                set.Add("BANK_TERM", txt_BANK_TERM.GetValue());
                set.Add("CON_TERM", txt_CON_TERM.GetValue());
                set.Add("UPDATE_ID", UserInfo.UserID);
                _WSCOM.ExecuteNonQueryTx("APG_WM60150.SAVE_PO_DET", set);
            }
        ...
        protected override void BtnQuery_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                source = _WSCOM.ExecuteDataSet("APG_WM60150.INQUERY", set, "OUT_CURSOR");
        ...
        private void grd01_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            try
            {
                ...
                source = _WSCOM.ExecuteDataSet("APG_WM60150.INQUERY_DET", set, "OUT_CURSOR");
                ...
                if (source.Tables[0].Rows.Count > 0)
                {
                    ...
                    txt_BANK_TERM.SetValue(source.Tables[0].Rows[0]["BANK_TERM"].ToString());
                    panel1.Visible = true;
                }
                else
                {
        ...
        private void PrintPO(string po)
        {
            ...
            param.Add("PONO", po);
            DataSet ds = _WSCOM.ExecuteDataSet("APG_WM60150.PRINT_PO", param);
        ...
        private void axTextBox1_TextChanged(object sender, EventArgs e)
        {
