...
namespace Ax.SIS.WM.UI
{
    ...
    /// - 작 성 일 : 2015-02-09<br />
    /// </summary>
    public partial class WM20540P1 : AxCommonPopupControl, IAxPopupHelper
    {
        ...
        protected override void UI_Shown(EventArgs e)
        {
            try
            {
                if (!this.IsCreated)
                {
                    ...
                    this.grd01.AddColumn(true, false, AxFlexGrid.FtextAlign.L, 080, "_VENDCD", "VENDCD", "VENDCD");
                    this.grd01.AddColumn(true, false, AxFlexGrid.FtextAlign.L, 060, "_VINCD", "VINCD", "VIN");
                    this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.L, 120, "Vehicle", "VINNM", "VINNM");
                    this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.L, 180, "ItemName", "ITEMNM", "ITEMNM");
        ...
        {
            return _WSCOM.ExecuteDataSet("APG_WM20540.INQUIRY_PARTNO", set).Tables[0];
        }
