...
namespace Ax.SIS.XM.UI
{
    ...
    public partial class XM39011 : AxCommonBaseControl
    {
        //private IXM39011 _WSCOM;
        private AxClientProxy _WSCOM;
		private string PACKAGE_NAME = "APG_XM39011";
        ...
        public XM39011()
        {
            ...
            //_WSCOM = ClientFactory.CreateChannel<IXM39011>("PM00", "XM39011.svc", "CustomBinding");
        ...
        private void XM39011_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void SetGridStyle(int cnt)
        {
            try
            {
                //if (cnt == 1)
                //{
                //    this.grd01.Styles.Alternate.BackColor = Color.FromArgb(244, 251, 255);
                //    return;
                //}
                //else
                //{
                ...
                for (int r = this.grd01.Rows.Fixed; r < this.grd01.Rows.Count; r = r + cnt)
                {
                    ...
                    for (int i = this.grd01.Cols["D0"].Index; i <= this.grd01.Cols["D30"].Index; i++)
                    {
                        ...
                        for (int idx = 0; idx < cnt; idx++)
                        {
                            ...
                            //출고가 마이너스이면 배경색 핑크로 표시
                            if (div.Equals("DIV3"))
                            {
                                out_qty = Convert.ToInt32(this.grd01.GetValue(r + idx, i));
                                if (out_qty < 0)
                                    this.grd01.SetCellStyle(r + idx, i, "csPink");
                            }
                        }
                        ...
                        ////두번째 날짜부터는 전날의 기말재고가 오늘의 기초재고와 다르면 배경색 핑크로 표시함.
                        //if (i > this.grd01.Cols["D0"].Index)
                        //{
                        //    int prev_end_qty = Convert.ToInt32(this.grd01.GetValue(r + 3, i - 1));
                        //    int beging_qty = Convert.ToInt32(this.grd01.GetValue(r, i));
                        //    if (prev_end_qty != beging_qty && beging_qty != 0)
                        //    {
                        //        this.grd01.SetCellStyle(r, i, "csPink");
                        //    }
                        //}
