...
namespace Ax.SIS.QA.QA02.UI
{
    ...
    /// </summary>
    public partial class QA20713 : AxCommonBaseControl
    {
        //private IQA20713 _WSCOM;
        ...
        private string PAKAGE_NAME = "APG_QA20713";
        ...
        public QA20713()
        {
            ...
            //_WSCOM = ClientFactory.CreateChannel<IQA20713>("QA02", "QA20713.svc", "CustomBinding");
        ...
        protected override void UI_Shown(EventArgs e)
        {
            try
            {
                ...
                this.grd01.AddColumn(false, true, AxFlexGrid.FtextAlign.C, 120, "VAN 등록여부", "VAN_IF_YN", "VAN_IF_YN");
                ...
                this.grd02.AddColumn(false, true, AxFlexGrid.FtextAlign.C, 060, "차종", "VINCD", "VIN");
                ...
                this.grd02.AddColumn(false, true, AxFlexGrid.FtextAlign.C, 160, "첨부사진", "ATT_PHOTO", "ATT_PHOTO");
                this.grd02.AddColumn(false, true, AxFlexGrid.FtextAlign.C, 160, "첨부파일", "ATT_FILE", "ATT_FILE");
