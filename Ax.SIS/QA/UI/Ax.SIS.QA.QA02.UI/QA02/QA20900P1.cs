...
namespace Ax.SIS.QA.QA02.UI
{
    ...
    /// <b>거래처조회 팝업</b>
    /// - 생 성 자 : 이재한<br />
    /// - 생 성 일 : 2016-12-12 오후 16:59:51<br />
    /// </summary>
    public partial class QA20900P1 : AxCommonPopupControl, IAxPopupHelper
    {
        ...
        //#001
        public QA20900P1(string SEARCH_CODE)
        {
            InitializeComponent();
        ...
        public DataTable GetDataSource(HEParameterSet set)
        {
            ...
            return this.CodeBox_GetDataSourceChange(_WSCOM.ExecuteDataSet(string.Format("{0}.{1}", PAKAGE_NAME, "INQUERY_CD0070"), set));
        }
        ...
        protected override void UI_Shown(EventArgs e)
        {
            try
            {
                if (!this.IsCreated)
                {
                    ...
                    this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.C, 080, "업체코드", "VENDCD", "VENDCD");          // 거래처코드
                    this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.L, 299, "업체명", "VENDNM", "VENDNM");          // 거래처명

                    this.grd01.AddHiddenColumn("VENDNM2");
        ...
        private void Query_01(object sender, EventArgs e)
        {
            try
            {
                ...
                paramSet.Add("VENDCD", this.txt01_SEARCH.GetValue().ToString());

                //if (!IsQueryValid_01(paramSet)) return;

                this.BeforeInvokeServer(true);
                //DataSet source = _WSCOM.ExecuteDataSet(string.Format("{0}.{1}", "APG_QA20900", "INQUERY_CD0070"), paramSet);
