...
/* 
 * 프로그램명 : QA30712 X-BAR R 관리 결과 조회(기간별)
 * 설      명 : 
 * 최초작성자 : 
 * 최초작성일 : 
 * 최종수정자 : 
...
namespace Ax.SIS.QA.QA02.UI
{
    ...
    /// </summary>
    public partial class QA30712 : AxCommonBaseControl
    {
        //private IQA30712 _WSCOM;
        ...
        private string PAKAGE_NAME = "APG_QA30712";
        ...
        public QA30712()
        {
            ...
            //_WSCOM = ClientFactory.CreateChannel<IQA30712>("QA02", "QA30712.svc", "CustomBinding");
        ...
        protected override void UI_Shown(EventArgs e)
        {
            try
            {
                ...
                this.grd01.AddColumn(false, false, AxFlexGrid.FtextAlign.L, 100, "측정자", "MEAS_POINT", "MEAS_POINT");
                this.grd01.AddColumn(false, true, AxFlexGrid.FtextAlign.R, 080, "Gauge R&R",    "GATE_RNR");
                this.grd01.AddColumn(false, true, AxFlexGrid.FtextAlign.C, 130, "VAN 등록여부", "VAN_IF_YN", "VAN_IF_YN");
