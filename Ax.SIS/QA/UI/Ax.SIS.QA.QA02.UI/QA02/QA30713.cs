...
namespace Ax.SIS.QA.QA02.UI
{
    ...
    /// </summary>
    public partial class QA30713 : AxCommonBaseControl
    {
        //private IQA30713 _WSCOM;
        ...
        private string PAKAGE_NAME = "APG_QA30713";
        ...
        public QA30713()
        {
            ...
            //_WSCOM = ClientFactory.CreateChannel<IQA30713>("QA02", "QA30713.svc", "CustomBinding");
        ...
        protected override void UI_Shown(EventArgs e)
        {
            try
            {
                ...
                this.grd01.AddColumn(false, true, AxFlexGrid.FtextAlign.C, 160, "첨부사진", "ATT_PHOTO", "ATT_PHOTO");
                this.grd01.AddColumn(false, true, AxFlexGrid.FtextAlign.C, 160, "첨부파일", "ATT_FILE", "ATT_FILE");
