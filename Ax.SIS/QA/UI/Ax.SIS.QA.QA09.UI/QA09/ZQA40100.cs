...
namespace Ax.SIS.QA.QA09.UI
{
    ...
    /// 수지 Grade 관리
    /// </summary>
    public partial class ZQA40100 : AxCommonBaseControl
    {
        //private IPD40520 _WSCOM;
        private AxClientProxy _WSCOM_N;
        private string PACKAGE_NAME = "APG_ZQA40100";
        ...
        protected override void UI_Shown(EventArgs e)
        {
            try
            {
                ...
                this.axCodeBox1.HEPopupHelper = new Ax.SIS.CM.UI.CM20017P1(this.axCodeBox1);
                this.axCodeBox1.PopupTitle = this.GetLabel("VENDCD");// "업체 코드";
                ...
                this.grd01.AddColumn(true, false, AxFlexGrid.FtextAlign.L, 88, "VENDCD", "VENDCD", "VENDCD");
                this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.L, 120, "VENDOR NAME", "VENDNM", "VENDNM");
        ...
        protected override void BtnQuery_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                set.Add("CORCD", this.UserInfo.CorporationCode);
                set.Add("BIZCD", bizcd);
                set.Add("VENDCD", axCodeBox1.GetValue());
        ...
        private void grd01_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            {
                m_MID = mid;
                cdx01_VENDCD.SetValue(grd01.GetValue(row, "VENDCD").ToString());
