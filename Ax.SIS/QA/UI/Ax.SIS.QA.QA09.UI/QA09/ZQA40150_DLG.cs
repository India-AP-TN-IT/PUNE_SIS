...
namespace Ax.SIS.QA.QA09.UI
{
    ...
    /// </summary>
    public partial class ZQA40150_DLG : AxCommonPopupControl, IAxPopupHelper
    {
        ...
        public ZQA40150_DLG(string ty, string codeTitle, string descTitle, string codeText, string descText)
        {
            InitializeComponent();
        ...
        public DataTable GetDataSource(HEParameterSet set)
        {
            ...
            return _WSCOM_N.ExecuteDataSet("APG_ZQA40150.GET_DLG", paramSet, "OUT_CURSOR").Tables[0];
        }
        ...
        private void btn01_Inquery_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet source = _WSCOM_N.ExecuteDataSet("APG_ZQA40150.GET_DLG", paramSet, "OUT_CURSOR");
