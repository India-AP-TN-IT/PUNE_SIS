...
namespace Ax.SIS.QA.QA09.UI
{
    ...
    /// </summary>
    public partial class ZQA40160_DLG : AxCommonPopupControl, IAxPopupHelper
    {
        ...
        public ZQA40160_DLG(string ty, string codeTitle, string descTitle, string codeText, string descText)
        {
            InitializeComponent();
        ...
        protected override void UI_Shown(EventArgs e)
        {
            try
            {
                if (!IsCreated)
                {
                    ...
                    this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.L, 200, "Vendor", "VENDNM");
                    IsCreated = true;
                }
        ...
        public DataTable GetDataSource(HEParameterSet set)
        {
            ...
            return _WSCOM_N.ExecuteDataSet("APG_ZQA40160.GET_DLG", paramSet, "OUT_CURSOR").Tables[0];
        }
        ...
        private void btn01_Inquery_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet source = _WSCOM_N.ExecuteDataSet("APG_ZQA40160.GET_DLG", paramSet, "OUT_CURSOR");
