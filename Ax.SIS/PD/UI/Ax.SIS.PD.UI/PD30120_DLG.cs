...
namespace Ax.SIS.PD.UI
{
    ...
    /// </summary>
    public partial class PD30120_DLG : AxCommonPopupControl
    {
        private AxClientProxy _WSCOM_N;
        private SortedList<string, object> _HEUserParameterDummy;

        public PD30120_DLG(string codeTitle, string descTitle, string codeText, string descText)
        {
            InitializeComponent();
        ...
        public DataTable GetDataSource(HEParameterSet set)
        {
            ...
            return _WSCOM_N.ExecuteDataSet("APG_PD30120.INQUERY_DLG_PART", paramSet, "OUT_CURSOR").Tables[0];
        }
        ...
        private void btn01_Inquery_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet source = _WSCOM_N.ExecuteDataSet("APG_PD30120.INQUERY_DLG_PART", paramSet, "OUT_CURSOR");
