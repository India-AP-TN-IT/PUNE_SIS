...
namespace Ax.SIS.PD.UI
{
    ...
    /// 통전 검사 항목 그룹
    /// </summary>
    public partial class PD20130 : AxCommonBaseControl
    {
        //private IPD20130 _WSCOM;
        private AxClientProxy _WSCOM_N;
        private string PACKAGE_NAME = "APG_PD20130";
        ...
        protected override void UI_Shown(EventArgs e)
        {
            try
            {
                ...
                this.grd01.AddColumn(false, true, AxFlexGrid.FtextAlign.C, 120, "그룹코드", "ET_GRPCD", "GROUP_CODE");
                this.grd01.AddColumn(false, true, AxFlexGrid.FtextAlign.L, 200, "그룹명", "ET_GRPNM", "GROUP_DESC");
        ...
        protected override void BtnQuery_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                set.Add("BIZCD", bizcd);
                set.Add("ET_GRPCD", this.txt01_ET_GRPCD.GetValue());
                set.Add("ET_GRPNM", this.txt01_ET_GRPNM.GetValue());
        ...
        protected override void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                DataSet source = this.grd01.GetValue(AxFlexGrid.FActionType.Save,
                    "CORCD", "ET_GRPCD", "ET_GRPNM", "BIZCD", "EMPNO");
                ...
                //MsgBox.Show("입력하신 통전 검사 항목 그룹 정보가 저장되었습니다.");
                //저장되었습니다.
