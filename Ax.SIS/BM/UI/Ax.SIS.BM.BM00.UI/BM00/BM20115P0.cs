...
namespace Ax.SIS.BM.BM00.UI
{
    ...
    /// </summary>
    public partial class BM20115P0 : AxCommonPopupControl
    {
        private AxClientProxy _WSCOM_N;
        private SortedList<string, object> _HEUserParameterDummy;

        public BM20115P0(string codeTitle, string descTitle, string codeText, string descText)
        {
            InitializeComponent();
        ...
        public DataTable GetDataSource(HEParameterSet set)
        {
            ...
            paramSet.Add("TY_CODE", this.HEUserParameterGetValue("TY_CODE"));
            paramSet.Add("CODE", this.txt01_VENDCD.GetValue());
            paramSet.Add("DESC", this.txt01_VENDNM.GetValue());
