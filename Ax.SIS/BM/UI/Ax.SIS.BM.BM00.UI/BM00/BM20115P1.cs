...
namespace Ax.SIS.BM.BM00.UI
{
    ...
    /// </summary>
    public partial class BM20115P1 : AxCommonPopupControl
    {
        ...
        protected override void UI_Shown(EventArgs e)
        {
            try
            {
                if (!IsCreated)
                {
                    ...
                    this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.L, 100, "품목코드", "T_CODE");
                    this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.L, 180, "품목명", "T_DESC");
