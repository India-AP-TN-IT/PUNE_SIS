...
namespace Ax.SIS.TM.UI
{
    ...
    /// Location 마스터
    /// </summary>
    public partial class TM24100 : AxCommonBaseControl
    {
        ...
        protected override void UI_Shown(EventArgs e)
        {
            try
            {
                ...
                this.grd01.AddColumn(false, true, AxFlexGrid.FtextAlign.L, 180, "Truck No.", "TRKNO", "TRKNO");
                this.grd01.Cols["TRKNO"].Style.BackColor = Color.FromArgb(208, 253, 248);
                this.grd01.AddColumn(false, true, AxFlexGrid.FtextAlign.L, 280, "Truck Description", "TRKNM", "TRKNM");
                this.grd01.Cols["TRKNM"].Style.BackColor = Color.FromArgb(208, 253, 248);
        ...
        protected override void BtnQuery_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                set.Add("TRKNO", this.axTextBox1.GetValue());
                set.Add("TRKNM", this.axTextBox2.GetValue());
                this.BeforeInvokeServer(true);

                DataSet source = _WSCOM.ExecuteDataSet("APG_TM24100.INQUERY", set, "OUT_CURSOR");
        ...
        protected override void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (sourceIU.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        string trkno = Convert.ToString(rows["TRKNO"]).ToUpper().Replace(" ","");
                        rows["TRKNO"] = trkno;
                        if(string.IsNullOrEmpty(trkno))
                        {
                            MsgBox.Show("Truck No is mandatory!!");
                            return;
                        }
                    }
                    ...
                    _WSCOM.ExecuteNonQueryTx("APG_TM24100.DATA_SAVE", sourceIU);
                ...
                if (sourceD.Tables[0].Rows.Count > 0)
                {
                    ...
                    _WSCOM.ExecuteNonQueryTx("APG_TM24100.DATA_REMOVE", sourceD);
        ...
        {
            if(MsgBox.Show("Do you want to import WMS Truck Data?["+cbo01_BIZCD.GetText()+"]", "Question", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                HEParameterSet set = new HEParameterSet();
                set.Add("CORCD", this.UserInfo.CorporationCode);
                set.Add("BIZCD", this.UserInfo.BusinessCode);

                _WSCOM.ExecuteNonQueryTx("APG_TM24100.WMS_SYNC_DATA", set);
                BtnQuery_Click(null, null);
            }
        }
