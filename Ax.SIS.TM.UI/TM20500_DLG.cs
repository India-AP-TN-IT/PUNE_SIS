...
namespace Ax.SIS.TM.UI
{
    ...
    /// </summary>
    public partial class TM20500_DLG : AxCommonPopupControl, IAxPopupHelper
    {
        ...
        public TM20500_DLG(string ty, string codeTitle, string descTitle, string codeText, string descText)
        {
            InitializeComponent();
        ...
        protected override void UI_Shown(EventArgs e)
        {
            try
            {
                if (!IsCreated)
                {
                    ...
                    this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.L, 100, lbl01_VENDCD.GetValue().ToString(), "CD");
                    this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.L, 300, lbl01_VENDNM.GetValue().ToString(), "NM");
                    IsCreated = true;
                }
        ...
        public DataTable GetDataSource(HEParameterSet set)
        {
            ...
            return _WSCOM_N.ExecuteDataSet("APG_TM20500.INQUERY_DLG", paramSet, "OUT_CURSOR").Tables[0];
        }
        ...
        private void btn01_Inquery_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet source = _WSCOM_N.ExecuteDataSet("APG_TM20500.INQUERY_DLG", paramSet, "OUT_CURSOR");
