...
namespace Ax.SIS.TM.UI
{
    ...
    /// </summary>
    public partial class TM20300P1 : AxCommonPopupControl, IAxPopupHelper
    {
        ...
        protected override void UI_Shown(EventArgs e)
        {
            try
            {
                if (!this.IsCreated)
                {
                    ...
                    this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.C, 100, "Code", "PROCCD", "PROCCD");
                    this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.L, 150, "Name", "PROCNM", "PROCNM");
                    this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.L, 100, "DIV", "PROC_DIV", "PROCESS_DIV");
                    this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.C, 120, "B/DATE", "BEG_DATE", "PROC_APP_DATE");
                    this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.C, 120, "E/DATE", "END_DATE", "PROC_END_DATE");
