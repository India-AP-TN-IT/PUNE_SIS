...
namespace Ax.SIS.TM.UI
{
    ...
    /// 수지 Grade 관리
    /// </summary>
    public partial class TM23400 : AxCommonBaseControl
    {
        ...
        protected override void UI_Shown(EventArgs e)
        {
            try
            {
                ...
                this.grd01.AddColumn(false, true, AxFlexGrid.FtextAlign.R, 100, "Remain QTY", "CUR_QTY", "CUR_QTY");
                ...
                this.grd02.AddColumn(false, true, AxFlexGrid.FtextAlign.R, 110, "Issue QTY", "CUR_QTY", "CUR_QTY");
        ...
        protected override void BtnQuery_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet ds = _DB.ExecuteDataSet("APG_TM23400.INQUERY", param);
        ...
        private void GetDET(string partno)
        {
            ...
            DataSet ds = _DB.ExecuteDataSet("APG_TM23400.INQUERY_DET", param);
