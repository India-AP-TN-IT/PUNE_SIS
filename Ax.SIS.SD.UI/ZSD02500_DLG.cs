...
namespace Ax.SIS.SD.UI
{
    ...
    /// </summary>
    public partial class ZSD02500_DLG : AxCommonPopupControl
    {
        private AxClientProxy _WSCOM_N;
        private SortedList<string, object> _HEUserParameterDummy;

        public ZSD02500_DLG(string codeTitle, string descTitle, string codeText, string descText)
        {
            InitializeComponent();
        ...
        protected override void UI_Shown(EventArgs e)
        {
            try
            {
                if (!IsCreated)
                {
                    ...
                    this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.L, 200, "NAME", "T_DESC");
                    this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.R, 80, "PRICE", "UPRICE");
                    this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.C, 80, "HSN", "HSN");
                    this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.C, 80, "O/NO", "SANO");
        ...
        public DataTable GetDataSource(HEParameterSet set)
        {
            ...
            return _WSCOM_N.ExecuteDataSet("ZPG_ZSD02500.INQUERY_DLG_PART", paramSet, "OUT_CURSOR").Tables[0];
        }
        ...
        private void btn01_Inquery_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet source = _WSCOM_N.ExecuteDataSet("ZPG_ZSD02500.INQUERY_DLG_PART", paramSet, "OUT_CURSOR");
