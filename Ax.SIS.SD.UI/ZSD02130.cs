...
namespace Ax.SIS.SD.UI
{
    ...
    /// </summary>
    public partial class ZSD02130 : AxCommonBaseControl
    {
        ...
        protected override void UI_Shown(EventArgs e)
        {
            ...
            try
            {
                ...
                this.grd01.AddColumn(true, true, DEV.Utility.Controls.AxFlexGrid.FtextAlign.C, 100, "Plant Code", "PLANTCD", "PLANTCD");
                this.grd01.AddColumn(false, true, DEV.Utility.Controls.AxFlexGrid.FtextAlign.L, 300, "Plant Name", "PLANTNM", "PLANTNM");
                this.grd01.AddColumn(false, true, DEV.Utility.Controls.AxFlexGrid.FtextAlign.C, 100, "ZIP CODE", "ZIPCD", "ZIPCD");
                this.grd01.AddColumn(false, true, DEV.Utility.Controls.AxFlexGrid.FtextAlign.L, 400, "Address#1", "STRAS", "STRAS");
                this.grd01.AddColumn(false, true, DEV.Utility.Controls.AxFlexGrid.FtextAlign.L, 400, "Address#2", "ORT01", "ORT01");
                this.grd01.AddColumn(false, true, DEV.Utility.Controls.AxFlexGrid.FtextAlign.L, 400, "Address#3", "ORT02", "ORT02");
                this.grd01.AddColumn(false, true, DEV.Utility.Controls.AxFlexGrid.FtextAlign.L, 640, "F/Address", "ADDR", "ADDRESS");
                this.grd01.AddColumn(false, true, DEV.Utility.Controls.AxFlexGrid.FtextAlign.L, 150, "Distance", "DISTA", "DISTA");//
                this.grd01.AddColumn(false, true, DEV.Utility.Controls.AxFlexGrid.FtextAlign.L, 150, "GST NO", "STCD3", "STCD3");//사업자코드
                #endregion
        ...
        protected override void BtnQuery_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataSet source = _WSCOM_N.ExecuteDataSet("ZPG_ZSD02130.INQUERY", paramSet, "OUT_CURSOR");
        ...
        protected override void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet source = this.grd01.GetValue(AxFlexGrid.FActionType.Save, "CORCD", "BIZCD", "VENDCD", "PLANTCD", "PLANTNM", "ADDR", "DISTA", "STRAS", "ORT01", "ORT02", "ZIPCD", "STCD3");
                ...
                _WSCOM_N.ExecuteNonQueryTx(string.Format("{0}.{1}", "ZPG_ZSD02130", "SET_ADDR"), source);
