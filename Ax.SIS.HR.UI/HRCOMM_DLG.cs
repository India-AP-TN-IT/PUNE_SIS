...
namespace Ax.SIS.HR.UI
{
    ...
    /// </summary>
    public partial class HRCOMM_DLG : AxCommonPopupControl, IAxPopupHelper
    {
        private AxClientProxy _WSCOM_N;
        private SortedList<string, object> _HEUserParameterDummy;

        public HRCOMM_DLG(string codeTitle, string descTitle, string codeText, string descText)
        {
            InitializeComponent();
        ...
        protected override void UI_Shown(EventArgs e)
        {
            try
            {
                if (!IsCreated)
                {
                    ...
                    this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.L, 100, "CODE", "CODE");
                    this.grd01.AddColumn(true, true, AxFlexGrid.FtextAlign.L, 250, "NAME", "NAME");
        ...
        public DataTable GetDataSource(HEParameterSet set)
        {
            ...
            paramSet.Add("TY", this.HEUserParameterGetValue("TY"));
            paramSet.Add("CD", this.HEUserParameterGetValue("CD"));
            paramSet.Add("NM", this.HEUserParameterGetValue("NM"));
            return _WSCOM_N.ExecuteDataSet("ZPG_HRCOMMON.INQUERY", paramSet, "OUT_CURSOR").Tables[0];
        }
        ...
        private void btn01_Inquery_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                paramSet.Add("VENDCD", this.HEUserParameterGetValue("VENDCD"));
                paramSet.Add("TY", this.HEUserParameterGetValue("TY"));
                paramSet.Add("CD", txt01_VENDCD.GetValue());
                paramSet.Add("NM", txt01_VENDNM.GetValue());
                BeforeInvokeServer(true);
                DataSet source = _WSCOM_N.ExecuteDataSet("ZPG_HRCOMMON.INQUERY", paramSet, "OUT_CURSOR");
